...
namespace IntercompanyCore.Documents
{
    public class OV
    {
            ...
            public OV(int docEntry, int docNum, string cardCode, string cardName, string docCurrency, DateTime docDate, DateTime docDueDate, string discountPercent, char u_KAI01_Intercompany, char u_KAI01_Sincronizado, string u_KAI01_EmpresaDestino)
            {
                DocEntry = docEntry;
                DocNum = docNum;
                CardCode = cardCode;
