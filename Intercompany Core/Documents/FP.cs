...
namespace IntercompanyCore.Documents
{
    public class FP
    {
        ...
        public FP(string cardCode, DateTime docDate, DateTime docDueDate, char u_KAI01_Intercompany, char u_KAI01_Sincronizado, string u_KAI01_EmpresaDestino, string u_KAI01_SN, int u_KAI01_Referencia)
        {
            CardCode = cardCode;
            DocDate = docDate;
